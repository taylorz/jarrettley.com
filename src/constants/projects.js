...
import doz3 from "../assets/images/doz/doz-3.jpg"
import doz4 from "../assets/images/doz/doz-4.png"
import doz5 from "../assets/images/doz/doz-5.JPG"

import el1 from "../assets/images/el/el-1.png"
import el2 from "../assets/images/el/el-2.png"
import el3 from "../assets/images/el/el-3.png"
import el4 from "../assets/images/el/el-4.jpg"
import el5 from "../assets/images/el/el-5.jpg"
import el6 from "../assets/images/el/el-6.jpg"
import el7 from "../assets/images/el/el-7.jpg"
...
const PROJECTS = [
    {
        ...
        text: ["Occupied by Israel since 1967, Zaoura and Ein Fiett are adjacent Syrian villages in the Golan Heights used by the IDF as military training grounds for urban warfare. The IDF extracts the urban and architectural syntax of Zaoura and Ein Fiett as military knowledge and rehearses their weaponization into a medium warfare, simulating the defeat of future targets through the domination of its architectures and cities. The ruins of these villages bear witness to multiple temporalities of urbicide: their 1967 Israeli invasion and occupation, the ongoing destruction they incur as training sites, and the future urban military campaigns rehearsed and marked within its architectures. If urbicide is the killing of a city, enacted through the destruction of its vital infrastructures and buildings, then the IDF has subjected Zaoura and Ein Fiett to a near death experience, keeping their fragments alive just enough to enact a slow ruination by bullet and munition. Israel’s militarized-architecture regime operates over Zaoura in concert with an aesthetic regime of spectacle and performance. As sites of living memory for Syrian villagers, who have been banned from living in the town since 1967, the half-dead ruins of Zaoura and Ein Fiett are mechanized by the IDF not just as training sites, but also as staging grounds for spectacles that continually reproduce these ruins as visual technologies of state domination over Syrian memory.", "In Ein Fiett stands a residential structure whose material substrate is layered with years of military penetration: bullet holes splitting the blast radius of previous wounds, windows frames expanded into passageways, and new holes blasted through once solid walls. The ruins of the east wing of the house were digitally reconstructed using images of the building taken on site, archival photography, and satellite imagery. The model is used to examine the status of these ruins as an index of multiple temporalities of violence figured by intermingling forces of epistemic extraction, weaponization, simulation, and aesthetic production that converge on the site."],
        year: "2020",
        images: [
            doz1,
            doz2,
